...
export interface EchoNextjsProviderProps
  ...
  gdprConsent?: boolean;
  /**
   * Cart data from Next.js Commerce hooks (e.g. useCart from @vercel/commerce).
   */
  cart?: CartData;
  /**
   * Customer/session data from Next.js Commerce.
   */
  customer?: CustomerData;
  /**
   * Shop/store data from Next.js Commerce.
   */
  shop?: ShopData;
  /**
...
export function EchoNextjsProvider({
  appId,
  gdprConsent = true,
  cart,
  customer,
  ...
  onEvent,
  ...echoChatProps
}: EchoNextjsProviderProps): React.ReactElement {
  ...
  // CUSTOMER_IDENTIFIED / CUSTOMER_LOGOUT
  useEffect(() => {
